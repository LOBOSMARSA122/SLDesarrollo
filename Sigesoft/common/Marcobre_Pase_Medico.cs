...
namespace NetPdf
{
    public class Marcobre_Pase_Medico
    {
         ...
         List<ServiceComponentList> serviceComponent, List<DiagnosticRepositoryList> Diagnosticos, List<Antecedentes> habitos)
        {
            ...
            if (oft_agudeza != null)
            {
                correctores = oft_agudeza.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_ID) == null ? "" : oft_agudeza.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.OFTALMOLOGIA_ID).v_Value1Name;
            }
            ...
            if (anexo16 != null)
            {
                medicacion = anexo16.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_7C_CUELLO_ID) == null ? "" : anexo16.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_7C_CUELLO_ID).v_Value1;
            }
            else if (anexo312 != null)
            {
                medicacion = anexo312.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_7C_CUELLO_ID) == null ? "" : anexo312.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_7C_CUELLO_ID).v_Value1;
            }
            else
            {
