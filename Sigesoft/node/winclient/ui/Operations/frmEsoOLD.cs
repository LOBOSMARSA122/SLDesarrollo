...
{
    public partial class frmEsoOLD : Form
    {
        ...
        public frmEsoOLD(string serviceId, string componentIdByDefault, string action)
        {
            InitializeComponent();
        ...
        {
            var frm = new Operations.frmEsoOLD(_serviceIdByWiewServiceHistory, null, "View");
            frm.ShowDialog();
        }
        ...
        {
            //grdTotalDiagnosticos.DataSource = _tmpTotalDiagnosticByServiceIdList;
            Operations.frmRecetaMedica frm = new frmRecetaMedica(_tmpTotalDiagnosticByServiceIdList);
            frm.ShowDialog();
        }
