...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class cuidadopreventivoDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> i_ParametroId { get; set; }
        ...
        public cuidadopreventivoDto(String v_CuidadoPreventivoId, String v_PersonId, Nullable<DateTime> d_ServiceDate, Nullable<Int32> i_GrupoId, Nullable<Int32> i_ParametroId, Nullable<Int32> i_Valor, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate)
        {
